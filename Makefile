...
# Common source files
COMMON_SOURCES = $(COMMON_DIR)/gpio_control.c $(COMMON_DIR)/modbus_client.c $(COMMON_DIR)/tcp_communication.c $(COMMON_DIR)/parking_logic.c $(COMMON_DIR)/gate_control.c $(COMMON_DIR)/system_logger.c
...
$(BUILD_DIR)/servidor_central: $(BUILD_DIR) $(SRC_DIR)/servidor_central/main.c $(COMMON_SOURCES)
	$(CC) $(CFLAGS) -o $@ $(SRC_DIR)/servidor_central/main.c $(COMMON_SOURCES) $(LDFLAGS_FULL)
...
$(BUILD_DIR)/servidor_terreo: $(BUILD_DIR) $(SRC_DIR)/servidor_terreo/main.c $(COMMON_SOURCES)
	$(CC) $(CFLAGS) -o $@ $(SRC_DIR)/servidor_terreo/main.c $(COMMON_SOURCES) $(LDFLAGS_FULL)
...
$(BUILD_DIR)/servidor_andar1: $(BUILD_DIR) $(SRC_DIR)/servidor_andar1/main.c $(COMMON_SOURCES)
	$(CC) $(CFLAGS) -o $@ $(SRC_DIR)/servidor_andar1/main.c $(COMMON_SOURCES) $(LDFLAGS_FULL)
...
$(BUILD_DIR)/servidor_andar2: $(BUILD_DIR) $(SRC_DIR)/servidor_andar2/main.c $(COMMON_SOURCES)
	$(CC) $(CFLAGS) -o $@ $(SRC_DIR)/servidor_andar2/main.c $(COMMON_SOURCES) $(LDFLAGS_FULL)
